...
import com.sipapah.simpel.adapter.AdapterBerita;
import com.sipapah.simpel.helpers.MyFunction;
import com.sipapah.simpel.helpers.SharedPrefManager;
import com.sipapah.simpel.models.BeritaItem;
import com.sipapah.simpel.models.ResponseBerita;
import com.sipapah.simpel.network.ApiServices;
import com.sipapah.simpel.network.InitRetrofit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       btn_back.setOnClickListener(new View.OnClickListener() {
        ...
        if (conMgr.getActiveNetworkInfo() != null
            ...
            Snackbar.make(parentView, "Periksa koneksi internet anda", Snackbar.LENGTH_LONG).show();
        ...
        beritaCall.enqueue(new Callback<ResponseBerita>() {
            ...
            public void onResponse(Call<ResponseBerita> call, Response<ResponseBerita> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response == null) {
                        Snackbar.make(parentView, "Tidak ada Berita", Snackbar.LENGTH_LONG).show();
                    } else {
...
//                    progressDialog.dismiss();
            ...
            public void onFailure(Call<ResponseBerita> call, Throwable t) {
                Snackbar.make(parentView, "Tidak ada berita.", Snackbar.LENGTH_LONG)
